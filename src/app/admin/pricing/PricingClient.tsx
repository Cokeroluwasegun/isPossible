...
export function PricingClient({ initialItems }: PricingClientProps) {
                  ...
                  <tr key={item.id} className="hover:bg-gray-50">
                    {editingId === item.id ? (
                      ...
                      <>
                        ...
                        <td className="px-4 py-3 font-semibold text-gray-900">{formatCurrency(item.base_price * (1 + item.markup_pct / 100))}</td>
